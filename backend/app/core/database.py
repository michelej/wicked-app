...
class Database:
    ...
    async def ensure_indexes():
        ...
        await db.budgets.create_index("budget_items.category_id")
        ...
        await db.credit_card_transactions.create_index([("credit_card", 1), ("timestamp", -1)])
        await db.credit_card_transactions.create_index([("budget_id", 1), ("timestamp", -1)])
        await db.credit_card_transactions.create_index([("timestamp", -1)])
        await db.credit_card_transactions.create_index("category")
        await db.credit_card_transactions.create_index("category_id")
        await db.credit_card_transactions.create_index("type")
        await db.credit_card_transactions.create_index("is_charged")
